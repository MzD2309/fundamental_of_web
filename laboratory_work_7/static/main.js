...
// Проверка, является ли строка str числом (включая отрицательное).
...
function tokenize(str) {
    ...
    for (let i = 0; i < str.length; i++) {
        ...
        // Унарный минус: если минус стоит в начале или после оператора/скобки
        // и далее идёт цифра или точка, добавляем знак в собираемое число
        if (
            char === '-' &&
            (i === 0 || prevToken === '(' || isOperation(prevToken)) &&
